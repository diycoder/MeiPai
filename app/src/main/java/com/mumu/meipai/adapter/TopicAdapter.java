...
public class TopicAdapter extends BaseAdapter<MediaEntity,TopicAdapter.ViewHolder> {
    ...
    private MediaAdapter.CallBackListener mCallBack;
    ...
    public void setLoadMoreListener(MediaAdapter.CallBackListener loadMoreListener) {
    ...
    public void onBindItemViewHolder(ViewHolder holder,final int position) {
        if (dataList != null && dataList.size() > 0) {
            ...
            final MediaEntity mediaEntity = dataList.get(position-1);
            if (mediaEntity != null) {
