package com.mumu.vcamera.ui.record;
...
import com.mumu.vcamera.common.CommonIntentExtra;
import com.mumu.vcamera.log.Logger;
import com.mumu.vcamera.ui.BaseActivity;
import com.mumu.vcamera.ui.record.views.ProgressView;
import com.mumu.vcamera.utils.ConvertToUtils;
...
public class MediaRecorderActivity extends BaseActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MeiPaiApplication.getInstance().addActivity(this);
    ...
    public void onEncodeComplete() {
        Log.e("视频地址: " + mMediaObject.getOutputTempVideoPath());
        Log.e("视频截图地址: " + mMediaObject.getOutputVideoThumbPath());

        Toast.makeText(this, "视频地址: " + mMediaObject.getOutputTempVideoPath(), Toast.LENGTH_SHORT).show();
        Toast.makeText(this, "视频截图地址: " + mMediaObject.getOutputVideoThumbPath(), Toast.LENGTH_SHORT).show();
        ...
        bundle.putString("outputThumb", mMediaObject.getOutputVideoThumbPath());
