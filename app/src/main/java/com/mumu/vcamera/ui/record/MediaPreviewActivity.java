...
import com.mumu.vcamera.ui.record.views.ThemeGroupLayout;
import com.mumu.vcamera.ui.record.views.ThemeSufaceView;
import com.mumu.vcamera.ui.record.views.ThemeView;
import com.mumu.vcamera.utils.ConvertToUtils;
import com.mumu.vcamera.utils.IsUtils;
import com.mumu.vcamera.utils.ToastUtils;
...
public class MediaPreviewActivity extends BaseActivity implements
    ...
    private String mVideoThumbTempPath;
    ...
    private boolean prepareActivity() {
        ...
        mVideoThumbTempPath = getIntent().getStringExtra("outputThumb");

        //FIXME
//        Log.e("视频地址：",mVideoTempPath);
//        Log.e("视频截图地址：",mVideoThumbTempPath);
