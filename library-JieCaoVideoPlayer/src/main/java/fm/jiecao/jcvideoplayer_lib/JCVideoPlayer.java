...
//            jcVideoPlayer.setAnimation(ra);
    ...
    public void startWindowTiny() {
        ...
        try {
            ...
            int width = JCMediaManager.instance().currentVideoWidth;
            int height = JCMediaManager.instance().currentVideoHeight;

            if (width > mScreenWidth / 2 || height > mScreenHeight / 2) {
                width = (int) (width * 0.65f);
                height = (int) (height * 0.65f);
            }

            int margin = JCUtils.dip2px(getContext(), 40.0f);
