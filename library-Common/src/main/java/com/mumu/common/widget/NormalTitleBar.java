...
public class NormalTitleBar extends RelativeLayout {
    ...
    public NormalTitleBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        View.inflate(context, R.layout.tool_bar_normal, this);
    ...
    private void setToolBarHeight(float defHeight) {
        ViewGroup.LayoutParams layoutParams = rl_tool_bar.getLayoutParams();
        layoutParams.height = DisplayUtil.px2dip(defHeight);
        rl_tool_bar.setLayoutParams(layoutParams);
    }
